...
\begin{frame}[containsverbatim]
  ...
  \begin{lstlisting}[caption=Initialization of I2C driver]
...
\begin{frame}[containsverbatim]
  ...
  \begin{lstlisting}[caption=Device Tables used in our driver]
...
\begin{frame}[containsverbatim]
  ...
  \begin{lstlisting}[caption=Probe and remove functions in our driver]
...
\begin{frame}[containsverbatim]
  ...
  \vspace*{-14mm}
  \begin{lstlisting}[caption=Example of raw I2C API usage]
	int ret;
...
\begin{frame}[containsverbatim]
  ...
  \begin{lstlisting}[caption=Example of SMBus API usage]
	s32 data;
